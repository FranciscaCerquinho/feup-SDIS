...
public interface RMIinterface extends Remote{
	...
	void backup(String fileID,  int repDegree, FileInformation fileInformation) throws RemoteException, UnknownHostException, InterruptedException;
	...
	void reclaim(int maxDiskSpace, ArrayList<FileInformation> fileInformation) throws RemoteException, UnknownHostException, InterruptedException;
